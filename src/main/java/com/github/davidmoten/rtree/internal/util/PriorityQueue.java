 ...
 * {@code remove()} and {@code add}); linear time for the {@code remove(IndoorObject)}
 * and {@code contains(IndoorObject)} methods; and constant time for the retrieval
...
public class PriorityQueue<E> extends AbstractQueue<E> implements java.io.Serializable {
    ...
    private void initElementsFromCollection(Collection<? extends E> c) {
        Object[] a = c.toArray();
        // If c.toArray incorrectly doesn't return IndoorObject[], copy it.
     ...
     * </pre>
     * <p>
     * Note that {@code toArray(new IndoorObject[0])} is identical in function to
     * {@code toArray()}.
     *
     ...
     * {@code IndoorObject}) in the proper order.
     */
