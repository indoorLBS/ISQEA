...
public final class Node_ extends Table {
  public static Node_ getRootAsNode_(ByteBuffer _bb) {
    return getRootAsNode_(_bb, new Node_());
  }
  ...
  public Node_ __init(int _i, ByteBuffer _bb) {
    bb_pos = _i;
    bb = _bb;
    return this;
  }
  ...
  public Bounds_ mbb() {
    return mbb(new Bounds_());
  }

  public Bounds_ mbb(Bounds_ obj) {
    int o = __offset(4);
    return o != 0 ? obj.__init(__indirect(o + bb_pos), bb) : null;
  }

  public Node_ children(int j) {
    return children(new Node_(), j);
  }

  public Node_ children(Node_ obj, int j) {
    int o = __offset(6);
  ...
  public Entry_ entries(int j) {
    return entries(new Entry_(), j);
  }

  public Entry_ entries(Entry_ obj, int j) {
    int o = __offset(8);
    return o != 0 ? obj.__init(__indirect(__vector(o) + j * 4), bb) : null;
  }
  ...
  public static void addMbb(FlatBufferBuilder builder, int mbbOffset) {
    builder.addOffset(0, mbbOffset, 0);
  }
