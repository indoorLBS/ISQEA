...
public final class Bounds_ extends Table {
  public static Bounds_ getRootAsBounds_(ByteBuffer _bb) {
    return getRootAsBounds_(_bb, new Bounds_());
  }
  ...
  public Bounds_ __init(int _i, ByteBuffer _bb) {
    bb_pos = _i;
    bb = _bb;
    return this;
  }
  ...
  public static void startBounds_(FlatBufferBuilder builder) {
  ...
  public static void addBoxDouble(FlatBufferBuilder builder, int boxDoubleOffset) {
    builder.addStruct(2, boxDoubleOffset, 0);
  }
