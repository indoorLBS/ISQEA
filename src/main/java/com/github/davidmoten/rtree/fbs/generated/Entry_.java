...
public final class Entry_ extends Table {
  public static Entry_ getRootAsEntry_(ByteBuffer _bb) {
    return getRootAsEntry_(_bb, new Entry_());
  }

  public static Entry_ getRootAsEntry_(ByteBuffer _bb, Entry_ obj) {
    _bb.order(ByteOrder.LITTLE_ENDIAN);
    return (obj.__init(_bb.getInt(_bb.position()) + _bb.position(), _bb));
  }

  public Entry_ __init(int _i, ByteBuffer _bb) {
    bb_pos = _i;
    bb = _bb;
    return this;
  }

  public Geometry_ geometry() {
    return geometry(new Geometry_());
  }

  public Geometry_ geometry(Geometry_ obj) {
    int o = __offset(4);
