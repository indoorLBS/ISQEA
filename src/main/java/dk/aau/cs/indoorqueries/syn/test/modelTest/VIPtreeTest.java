...
//            if (i == 1) {
//                for (int j = 0; j < nodes.size(); j++) {
//                    LeafNode tempNode = (LeafNode)nodes.get(j);
//                    System.out.println();
...
//                            System.out.println(d2 + "-" + d1 + ": " + tempNode.getDistVIP(d2, d1));
//
//                        }
//                    }
//
...
////                        System.out.println((++h) + " " + key + " " + distMatrix.get(key));
