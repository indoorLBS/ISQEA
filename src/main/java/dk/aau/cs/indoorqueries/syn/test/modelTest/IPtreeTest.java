...
//            int parId = IndoorSpace.iCrucialPartitions.get(i).getmID();
//            System.out.println("crucial partitionId: " + parId);
//            System.out.println("partition's doors: " + IndoorSpace.iPartitions.get(parId).getmDoors());
//        }
...
//        for (int i = 0; i < IndoorSpace.iNumberParsPerFloor; i++) {
//            System.out.println("partitionId: " + i + "; partition's door: " + IndoorSpace.iPartitions.get(i).getmDoors());
//        }
